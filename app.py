...
.fuente-movil   { background:rgba(0,200,100,0.1);   color:#00c896;  border:1px solid rgba(0,200,100,0.2); }
.fuente-n8n     { background:rgba(255,100,50,0.1);  color:#ff6432;  border:1px solid rgba(255,100,50,0.2); }
    ...
    if not conn_test:
        ...
        if rows:
            ...
            for row in rows:
                ...
                fuente_class = f"fuente-{fuente}" if fuente in ["imagen", "video", "camara", "movil", "n8n"] else "fuente-imagen"
